...
public class Socle extends Node
{
	...
	public Socle()
	{
		...
		Geometry base = new Geometry("Box", new Box((float)0.6,(float) 0.1, (float)0.6,0,(float) -3.8, 0, "Stone.jpg"));  
		Geometry base1 = new Geometry("Box", new Box((float)0.2,(float) 1, (float)0.2,0, (float)-2.8, 0, "Stone.jpg"));  
		Geometry base2 = new Geometry("Box", new Box((float)0.5,(float) 0.1, (float)0.5,0, (float)-1.8, 0, "Stone.jpg"));  
